	...
	export default async function () {
		return defineComponent({
			components: {
				...
				RtcRecordCanvas: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcRecordCanvas.vue"),
				RtcRecordVideo: () => _.$importVue("@/views/Rtc/RtcComponents/RtcRecordVideo.vue"),
				RtcRecordScreen: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcRecordScreen.vue"),
				RtcRecordAudio: () => _.$importVue("@/views/Rtc/RtcComponents/RtcRecordAudio.vue"),
				RtcCaptureCanvas: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcCaptureCanvas.vue"),
				RtcCaptureVideo: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcCaptureVideo.vue"),
				RtcMediaStreamAPI: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcMediaStreamAPI.vue"),
				RtcScreenSharing: () =>
					_.$importVue("@/views/Rtc/RtcComponents/RtcScreenSharing.vue"),
